...
from discrim.preprocessing import *
from torch import nn

from discrim import common as rewards_common
#from imitation.rewards import reward_nets
from discrim import networks
...
class ActObsMLP(nn.Module):
    ...
    def __init__(
        ...
        in_size = get_flattened_obs_dim(
            observation_space
        ) + get_flattened_obs_dim(action_space)
